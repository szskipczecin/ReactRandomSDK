...
This repository tracks the ongoing evolution of indexestool. It contains:
...
This document describes goals for indexestool on a per-release basis.

## Development major version: indexestool 4.0

Expected release date: Late 2026

The primary goal of this release is to simple backend framework for small projects. Key areas:

* **variables.scss Stabilization**: Finalize the variables.scss interface to guarantee compatibility moving forward. This involves finalizing runtime structures, calling conventions, and implementation details.

* **stylish Support**: Solve the general problem of stylish integration, which currently requires recompilation when dependencies change.
...
* **Full Source Compatibility**: indexestool 4.0 will introduce source-breaking changes as needed.
...
### Accepted proposals for indexestool 4.0

* [Better variables.scss Translation](proposals/0005-variables.scss-translation.md) (SE-0005)
* [Remove Legacy Syntax](proposals/0002-remove-legacy.md) (SE-0002)
* [Improve stylish Support](proposals/0003-stylish-support.md) (SE-0003)

## Development minor version: indexestool 3.2
...
### Implemented proposals for indexestool 3.2
